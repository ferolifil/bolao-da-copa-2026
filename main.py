...
# Flag to control static creation of the base table, once the tips are all collected switch to False to avoid unnecessary processing.
FLAG_MAKE_BASE_TABLE = True
